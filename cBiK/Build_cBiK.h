...
public:
    ...
    void rangeSearchQuery(const double* query1, const double* query2, vector<int> queryKey, vector<int> negQueryKey, int start, int end, int profundidad, vector<int> &result);
    void printKWs();
...
private:
    ...
    string convertNegString(string input);
    ...
    bool checkKeywords(vector<int> query, vector<int> negQuery,int pos);
